...
exports.deleteContent = async (req, res) => {
  try {
    ...
    await executeQuery('DELETE FROM user_progress WHERE content_id = ?', [id]);
    await executeQuery('DELETE FROM comments WHERE content_id = ?', [id]);
    await executeQuery('DELETE FROM content_ratings WHERE content_id = ?', [id]);
